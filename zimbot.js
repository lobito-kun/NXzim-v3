...
let drips = [
  ...
  break
          ...
          urlButton: {
                  displayText: 'GITHUB',
                  url: 'https://github.com/lobito-kun/NXzim-v3'
          }
                            }]
...
*Mime* : ${baby1[0].mime}
*Link* : ${baby1[0].link}\n
_whoa wait NixiServer processing..._
...
break
           ...
           // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)                       
            ...
            if (!args[0]) throw 'link github  EXAMPLE: https://github.com/lobito-kun/NXzim-v3'
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `beta`, url : `https://github.com/lobito-kun/NXzim-v3` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/lobito-kun/NXzim-v3` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
...
┃ 
┃      ↣Mx↢ 
┃https://github.com/lobito-kun/NXzim-v3
┃
┃━━━━━━━━━━━━━━━━━━┃
┃                  nixi
╰━━━━━━━━━━━━━━━━━━╯
